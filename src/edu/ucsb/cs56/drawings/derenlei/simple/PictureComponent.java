package edu.ucsb.cs56.drawings.derenlei.simple;
...
/**
   A component that draws a Picture by Phill Conrad and Deren Lei
   
   @author Phill Conrad (original drawing)
   @author Deren Lei (fixed the snowmans's head)
...
{  
	...
	g2.draw(snowManTopCircle);// @@@ ADD CODE HERE TO DRAW THE TOP CIRCLE
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        ...
        g2.drawString("Deren Lei's snowman with a nice head", 20,20);
