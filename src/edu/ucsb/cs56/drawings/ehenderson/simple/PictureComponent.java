package edu.ucsb.cs56.drawings.ehenderson.simple;
...
/**
   ...
   @author Ethan Henderson (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("Snowman and House by Ethan Henderson", 20,20);
