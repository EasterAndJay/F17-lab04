package edu.ucsb.cs56.drawings.jhertzberg.simple;
...
/**
   ...
   @author Yossi Hertzberg (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("snowman drawing by Yossi Hertzberg", 20,20);
